# Executive Speech Coaching Site — Project Spec

This Hugo + Tailwind site is for Daniel Reece, an executive speech coach in NYC. The site must:

- Convert high-value leads (executives, performers, professionals)
- Follow www.buildingasecondbrain.com layout & flow
- Include: Homepage, About, Services, Booking, Blog, Testimonials, Contact
- Use deep navy, orange/gold, white
- Prioritize speed, clarity, accessibility, mobile-first
- Blog style: Like Blowfish theme
